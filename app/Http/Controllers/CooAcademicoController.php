...
class CooAcademicoController extends Controller
{
	...
	public function store()
	{
		...
		if ($validator->fails()) {
			...
			$user->perfil = 'Coordinador Academico';
			$user->password = bcrypt($pass);

			$user->save();


			$mensaje = 'Coordinador Academico creado correctamente! Tome nota, la clave para que ' . $persona->nombres . ' ingrese al sistema es: ' . $pass;
	...
	public function show($id)
	{
		...
		if(is_null($persona)){
			...
			return view('compartido.cooAcademico.mostrar');
		}
		return view('compartido.cooAcademico.mostrar', compact('persona'));
	}
	...
	public function edit($id)
	{
		...
		return view('compartido.cooAcademico.editar', compact('persona'));
	}
	...
	public function update($id)
	{
		...
		\Session::flash('message', 'Coordinador Academico Actualizado Correctamente');
		return \Redirect::to('gestionar/coordinadores-academicos/persona');
	...
	public function destroy($id)
	{
		...
		\Session::Flash('message','Coordinador Academico Eliminado Correctamente');
		return Redirect::to('gestionar/coordinadores-academicos/persona');
	}


	public function buscarAcademicos ()
	{
		$users = Persona::buscarIds('Coordinador Academico');
		$ids = Persona::obtenerIds($users);
		$academicos = Persona::obtenerModelos($ids);
