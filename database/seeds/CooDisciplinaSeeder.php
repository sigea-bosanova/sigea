    ...
    class CooDisciplinaSeeder extends Seeder
    {
...

        {
            ...
            $faker = Faker::create('es_ES');
               ...
               $aux = $faker->numberBetween($min = 1040000000,$max = 1050000000);
                    ...
                    $persona = Persona::create(array(
                        ...
                        'email' => $faker->email,
                        'edu_bas_primaria' => $faker->numberBetween($min = 1, $max = 5),
                        'edu_bas_secundaria' => $faker->numberBetween($min = 6, $max = 9),
                        'edu_bas_media' => $faker->numberBetween($min = 10, $max = 11),
                        ...
                        'experiencia_sector_publico_mese' => $faker->numberBetween($min = 1, $max = 12),
                        ...
                        'juramento' => $faker->sentence($nbWords = 4),
               ...
               $usuarioProfesor =  User::create(['id'=> $aux,
                                                'email' => $faker->email,
                                                'perfil' => 'cooDisciplina',
                                                'password' => bcrypt('cooDisciplina'),
                                                'activo' => true]);
