    ...
    @section('contenido')
        ...
        <h2 class="header smaller lighter blue">Creando Estudiante</h2>
        ...
        <div class="col-md-10">
            ...
            {!! Form::open(['id' => 'formulario', 'method' =>'post', 'route' => 'gestionar.estudiantes.estudiante.store']) !!}

            @include('compartido.estudiante.formulario')
                ...
                <div class="modal-dialog modal-sm">
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <h4 class="modal-title">Creando Estudiante...</h4>
                        </div>
