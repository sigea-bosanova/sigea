    ...
    @section('contenido')
        ...
        <div class="col-md-10">
            ...
            {!!  Form::model($persona, ['id' => 'formulario','route' => ['gestionar.coordinadores-disciplina.persona.update', $persona->id], 'method' => 'PUT']) !!}
                ...
                <div class="modal-dialog modal-sm">
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <h4 class="modal-title">Actualizando Coordinador de Disciplina</h4>
                        </div>
