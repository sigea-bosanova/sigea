    ...
    @if(isset($materia))
            ...
            {!! Form::open(['id' => 'formulario', 'method' => 'put', 'route' => ['coordinador-academico.materia.update', $materia->id],]) !!}
                ...
                <div class="widget-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-6 col-sm-6">
                                <div class="input-group">
                                    ...
                                    {!! Form::select('grado_id', $grados, $materia->grado->id, ['class' => 'form-control']) !!}
                                </div>
                            </div>
                        </div><br>
                        ...
                        <div class="row">
                            <div class="col-xs-6 col-sm-6">
                                ...
                                <span class="input-group-addon">
                                    ...
                                    {!! Form::textarea('logro1', $materia->logro1 , ['class' => ' form-control ']) !!}
                            ...
                            <div class="col-xs-6 col-sm-6">
                                ...
                                <span class="input-group-addon">
                                    ...
                                    {!! Form::textarea('logro2', $materia->logro2, ['class' => 'form-control']) !!}
                                </div>
                            </div>
                        </div><br>
                    ...
                    <span class="input-group-addon">
                        <i class="ace-icon fa fa-book"></i> Logro Tercer Periodo:
                                    ...
                                    {!! Form::textarea('logro3', $materia->logro3 , ['class' => ' form-control ']) !!}
                    ...
                    <span class="input-group-addon">
                        <i class="ace-icon fa fa-book"></i> Logro Cuarto Periodo:
                                    ...
                                    {!! Form::textarea('logro4', $materia->logro4, ['class' => 'form-control']) !!}
                                </div>
                            </div>
                        </div><br>
            ...
            <span class="input-group-addon">
                <i class="ace-icon fa fa-book"></i> Logro Final:
                                    ...
                                    {!! Form::textarea('logro_final', $materia->logro_final , ['class' => ' form-control ']) !!}
